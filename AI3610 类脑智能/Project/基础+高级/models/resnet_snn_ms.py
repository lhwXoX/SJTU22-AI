...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1, option='A'):
        ...
        self.IFNode = neuron.IFNode(surrogate_function=surrogate.ATan(), detach_reset=True)
        self.IFNode2 = neuron.IFNode(surrogate_function=surrogate.ATan(), detach_reset=True)
